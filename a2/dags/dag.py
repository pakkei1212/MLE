...
with DAG(
    ...
    # Define task dependencies to run scripts sequentially
    dep_check_source_data_bronze_1 >> bronze_clickstream >> silver_table_1 >> gold_feature_store
    dep_check_source_data_bronze_2 >> bronze_financials >> silver_table_1 >> gold_feature_store
    dep_check_source_data_bronze_3 >> bronze_attributes >> silver_table_2 >> gold_feature_store
