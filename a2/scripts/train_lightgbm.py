...
def main(args):
    ...
    pipe = Pipeline([("prep", preprocessor), ("clf", lgbm)])

    param_dist = {
        "clf__n_estimators": [200, 300, 600],
    ...
    # dumps
    model_version = f"credit_model_lgbm_{args.model_train_date.replace('-','_')}"
    ...
    spark.stop()
    print("\n[DONE] LightGBM training completed.")

if __name__ == "__main__":
    ap = argparse.ArgumentParser(description="Train LightGBM on Gold features + labels")
